...
class bcwr_ansys(EasyFrame):
    ...
    def __init__(self):
        ...
        self.addLabel(text = "伸缩力产生的钢轨最大、最小纵向力及其位置（m,kN）",
                      row = 0, column = 0)
        ...
        self.addLabel(text = "挠曲力产生的钢轨最大、最小纵向力及其位置（m,kN）",
                      row = 1, column = 0)
        ...
        self.addLabel(text = "制动力产生的钢轨最大、最小纵向力及其位置（m,kN）",
                      row = 2, column = 0)
        ...
        # The command button1
        self.addButton(text = "ANSYS分析", row = 3, column = 0,
                       command = self.ANSYS)



        # The command button2
        self.addButton(text = "生成结果文件和图片", row = 3, column = 1,
                       command = self.result_display)

        # The command button3
        self.addButton(text = "各种附加力的最不利值", row = 3, column = 2,
    ...
    def result_display(self):
        ...
        for lj in lujing:
            ...
            plt.grid(b=True, which='major', axis='both')
            #plt.show()
            plt.savefig(lj + "\\pd-weiyi", dpi=800)
            plt.close('all')
            ...
            plt.grid(b=True, which='major', axis='both')
            #plt.show()
            plt.savefig(lj + "\\pd-force", dpi=800)
            plt.close('all')
...
#            plt.grid(b=True, which='major', axis='both')
#            #plt.show()
#            plt.savefig(lj + "\\bridge_jdweiyi", dpi=800)
#            plt.close('all')
#            
...
#            plt.grid(b=True, which='major', axis='both')
#            #plt.show()
#            plt.savefig(lj + "\\bridge_xdweiyi", dpi=800)
#            plt.close('all')
#            
#            
#            
...
#            plt.grid(b=True, which='major', axis='both')
#            #plt.show()
#            plt.savefig(lj + "\\rail_jdweiyi", dpi=800)
#            plt.close('all')
